...
public class MainActivity extends AppCompatActivity {
        ...
        builder.setTitle ( "Texto a enviar:" )
                ...
                .setPositiveButton("Enviar", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        intent.putExtra ( Intent.EXTRA_EMAIL, new String [] { "alu.19130519@correo.itlalaguna.edu.mx" } );
                        intent.putExtra ( Intent.EXTRA_CC,    new String [] { "robertoesquiveltr16@gmail.com"     } );
    ...
    public void btnExploradorArchsClick    ( View v ) {
        ...
        try {
            ...
            // *** COMPLETAR EL CODIGO AQUI ***
            startActivityForResult(Intent.createChooser(intent, "Seleccione una ocion."), CODIGO_SELECCIONAR_ARCHIVO);
