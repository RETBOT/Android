...
public class MenuPopupActivity extends AppCompatActivity implements View.OnLongClickListener,
    ...
    public boolean onMenuItemClick ( MenuItem item ) {
        ...
        switch (id){
            case R.id.mniApodoAmlo: edtApodo.setText("AMLO"); break;
            case R.id.mniApodoBorolas:edtApodo.setText("Borolas"); break;
            case R.id.mniApodoPenita:edtApodo.setText("Peñita"); break;
