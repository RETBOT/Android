...
:*
:*                    Clase que despliega la bandera de Estados Unidos
:*
:*  Archivo     : MainActivity.java
:*  Autor       : Roberto Esquivel Troncoso     19130519
:*  Fecha       : 18/09/2022
:*  Compilador  : Android Studio Artic Fox 2020.3
:*  Descripción : Este Activity despliega la bandera de USA fromada
...
public class BanderaUSA extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_banderausa);
        Toast.makeText(
                this,
                "Bandera 2 (onCreate)",
                Toast.LENGTH_SHORT
